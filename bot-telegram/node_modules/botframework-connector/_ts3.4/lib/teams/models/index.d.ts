 ...
 */
export declare type TeamsMeetingInfoResponse = TeamsMeetingInfo & {
    /**
     * The underlying HTTP response.
     */
    _response: HttpResponse & {
 ...
 */
export declare type TeamsSendMeetingNotificationResponse = TeamsMeetingNotificationRecipientFailureInfos & {
    /**
     * The underlying HTTP response.
     */
    _response: HttpResponse & {
