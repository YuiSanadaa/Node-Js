...
export declare class Teams {
     ...
     */
    fetchMeetingInfo(meetingId: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<TeamDetails>): Promise<Models.TeamsMeetingInfoResponse>;
    /**
     * @param meetingId Meeting Id, encoded as a BASE64 string.
     * @param callback The callback
     */
    fetchMeetingInfo(meetingId: string, callback: msRest.ServiceCallback<TeamsMeetingInfo>): void;
    /**
     * @param meetingId Meeting Id, encoded as a BASE64 string.
     * @param options The optional parameters
     * @param callback The callback
     */
    fetchMeetingInfo(meetingId: string, options: msRest.RequestOptionsBase | msRest.ServiceCallback<TeamDetails>, callback: msRest.ServiceCallback<TeamsMeetingInfo>): void;
    /**
     ...
     * @param options The optional parameters.
     */
    sendMeetingNotification(meetingId: string, notification: TeamsMeetingNotification, options?: msRest.RequestOptionsBase): Promise<Models.TeamsSendMeetingNotificationResponse>;
    /**
     * @param meetingId Meeting Id.
     * @param notification The content and configuration for the notification to send.
     * @param callback The callback.
     */
    sendMeetingNotification(meetingId: string, notification: TeamsMeetingNotification, callback: msRest.ServiceCallback<TeamsMeetingNotificationRecipientFailureInfos | {}>): void;
    /**
     * @param meetingId Meeting Id.
     * @param notification The content and configuration for the notification to send.
     * @param options The optional parameters.
     * @param callback The callback.
     */
    sendMeetingNotification(meetingId: string, notification: TeamsMeetingNotification, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<TeamsMeetingNotificationRecipientFailureInfos | {}>): void;
}
