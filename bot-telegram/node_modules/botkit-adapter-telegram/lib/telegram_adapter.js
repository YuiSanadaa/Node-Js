...
class TelegramAdapter extends botbuilder_1.BotAdapter {
    ...
    activityToTelegram(activity) {
        ...
        const message = {
            ...
            reply_markup: hasKeyboard ? Object.assign(Object.assign(Object.assign({}, (replyKeyboard ? { keyboard: replyKeyboard } : {})), (replyInlineKeyboard ? { inline_keyboard: replyInlineKeyboard } : {})), { resize_keyboard: true, one_time_keyboard: true }) : {
                ...
                if (activity.type === botbuilder_1.ActivityTypes.Message) {
                    ...
                    try {
                        ...
                        if (message.sender_action === 'typing_on') {
                            const res = yield api.callAPI('sendChatAction', 'POST', { chat_id: message.chat_id, action: "typing" });
    ...
    processActivity(req, res, logic) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (event.callback_query && event.callback_query.message && event.callback_query.message.message_id) {
                 ...
                 */
                const message = Object.assign(Object.assign({}, event.callback_query.message), { text: event.callback_query.data, from: event.callback_query.from });
                ...
                try {
                    ...
                    yield telegramAPI.callAPI('editMessageText', 'POST', {
